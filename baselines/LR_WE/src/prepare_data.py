...
if __name__ == '__main__':
    ...
    os.system(f'cp -r {DreamLoc_data_dir}/{project}/corpus/preprocessed_codes ../data/{project}/corpus/')
    os.system(f'cp {DreamLoc_data_dir}/{project}_word2vec.txt ../data/{project}/')
