...
def train_model():
    model = DeepLocator(report_emb=report_idx2vec, code_emb=code_idx2vec, word_emb=word_idx2vec, n_kernels=N_KERNELS)
...
if __name__ == '__main__':
    ...
    code_idx2vec = load_file(configs.code_idx2vec_path)
    report_idx2vec = load_file(configs.bugidx2vec_path)
