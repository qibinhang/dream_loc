...
project_log_dir = f'/home/LAB/qibh/Documents/BugLocalizationResearch/DreamLoc_for_github/DeepLocator/data/{project}/log/neg_{num_neg}'
...
for idx, (bz, lr, nk, ep) in enumerate(param):
    cmd = f'python -u deep_locator.py --project {project} --lr {lr} --batch_size {bz} '\
